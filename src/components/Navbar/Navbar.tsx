...
const Navbar = () => {
  return (
    <div className="  font-merienda font-semibold text-md text-white">
      <nav className="bg-black py-2  h-19 ">
        ...
        <ul className="flex justify-end space-x-10  text-center mx-5">
          <li
            className="hover:text-orange-600 flex cursor-pointer"
            onClick={() => {
              console.log("You clicked on the profile");
            }}
          >
            <svg
